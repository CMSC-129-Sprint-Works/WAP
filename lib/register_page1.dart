  ...
  _userRegister(bool usernameTaken) async {
    if (usernameTaken == false) {
      try {
        ...
        shared.setString("firstname", _newfirstnameController.text);
        shared.setString("lastname", _newlastnameController.text);
    ...
    return Column(
      ...
      children: <Widget>[
        Text('By clicking Register, you accept the ',
            key: Key('TC1'), style: TextStyle(fontFamily: 'Montserrat')),
        TextButton(
            onPressed: () {
              createTC(context);
              //TermsAndConditions();
